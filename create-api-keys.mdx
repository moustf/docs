...
<img src="/images/create-api-key-home.png" alt="Create API key from dashboard page" />
<img src="/images/create-api-key-api-key-page.png" alt="Create API key from API key page" />
...
<img src="/images/create-api-key-pop-up.png" alt="Create API key pop up" />

After creating the API key, You can now copy the API Key Identifier from Hamsa Dashboard and use it in the routes!

<img src="/images/copy-api-key.png" alt="Copy API kye" />
